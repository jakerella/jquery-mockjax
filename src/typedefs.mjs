 ...
 * @typedef {{[key: string]: (string | RequestData | Array)}} RequestData
 */
 ...
 * @property {{[key: string]: LogMethod}} logger - Logger object
 ...
 * @property {(ResponseHandler | null)} response - Default response function
 ...
 * @property {{[key: string]: string}} headers - Deprecated, use responseHeaders
 * @property {{[key: string]: string}} responseHeaders - Default response headers
 ...
 * @property {?{[key: string]: string}} requestHeaders - The HTTP request headers to match against
 ...
 * @property {?ResponseHandler} response - A function to call for generating the HTTP Response
 ...
 * @property {?{[key: string]: string}} responseHeaders - The HTTP response headers to return
 ...
 * @property {{[key: string]: string}} headers - Any request headers to send ({})
