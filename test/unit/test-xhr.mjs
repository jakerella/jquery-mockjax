...
/* ----------------- */
QUnit.module('XHR: READYSTATE constants')
/* ----------------- */
...
/* ----------------- */
QUnit.module('XHR: createMockXHR - basic structure')
/* ----------------- */
...
/* ----------------- */
QUnit.module('XHR: createMockXHR - methods')
/* ----------------- */
...
/* ----------------- */
QUnit.module('XHR: createMockXHR - response handling')
/* ----------------- */
...
/* ----------------- */
QUnit.module('XHR: determineResponseTime', {
    beforeEach: () => {
...
it('should return default when responseTime is 0', (assert) => {
    ...
    const defaultTime = settingsModule.getSettings().responseTime
