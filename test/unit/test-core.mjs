...
/* ----------------- */
QUnit.module('Core: realAjaxCall', {
    afterEach: () => {
        clearAll()
        clearRetainedAjaxCalls()
    }
...
/* ----------------- */
QUnit.module('Core: registerMockjaxHandler - basic functionality', {
    afterEach: () => {
        clearAll()
        clearRetainedAjaxCalls()
    }
...
/* ----------------- */
QUnit.module('Core: registerMockjaxHandler - validation', {
    afterEach: () => {
        clearAll()
        clearRetainedAjaxCalls()
    }
...
/* ----------------- */
QUnit.module('Core: mockAjaxCall - basic mocking', {
    beforeEach: () => {
...
it('should not retain the mocked call with limit "false"', (assert) => {
    ...
    mockGetSettings().retainAjaxCalls = false
...
it('should retain the mocked call with limit "true"', (assert) => {
    ...
    mockGetSettings().retainAjaxCalls = true
...
it('should retain the correct number of calls with limit set as number', (assert) => {
    ...
    mockGetSettings().retainAjaxCalls = 2
...
it('should throw error for unmocked request when throwUnmocked is true', (assert) => {
    settingsModule.resetSettings()
    settingsModule.getSettings().throwUnmocked = true
...
/* ----------------- */
QUnit.module('Core: clear (deprecated)', {
    afterEach: () => {
        clearAll()
        clearRetainedAjaxCalls()
    }
...
/* ----------------- */
QUnit.module('Core: handler (deprecated)', {
    afterEach: () => {
        clearAll()
        clearRetainedAjaxCalls()
    }
...
/* ----------------- */
QUnit.module('Core: unfiredHandlers', {
    afterEach: () => {
        clearAll()
        clearRetainedAjaxCalls()
    }
...
/* ----------------- */
QUnit.module('Core: mockedAjaxCalls', {
    afterEach: () => {
        clearAll()
        clearRetainedAjaxCalls()
    }
...
/* ----------------- */
QUnit.module('Core: unmockedAjaxCalls', {
    afterEach: () => {
        clearAll()
        clearRetainedAjaxCalls()
    }
...
/* ----------------- */
QUnit.module('Core: clearRetainedAjaxCalls', {
    afterEach: () => {
        clearAll()
        clearRetainedAjaxCalls()
    }
...
/* ----------------- */
QUnit.module('Core: redirect handling', {
    beforeEach: () => {
